 ...
 */
fun Char.isSlashDot(): Boolean = this.toInt() == Constants.KANA_SLASH_DOT

/**
 * Returns `true` if this is 'ー'.
 */
fun Char.isLongDash(): Boolean = this.toInt() == Constants.PROLONGED_SOUND_MARK
 ...
 */
fun Char.isEnglishUpperCase(): Boolean = this.toInt() in Constants.LATIN_UPPERCASE_RANGE
